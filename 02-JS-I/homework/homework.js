...
function conversorEuroADolar(euro)
{
  var resultadoConversion;
  resultadoConversion = (euro * 1.20) / 1;
...
function deEuroAdolar(euro){
  ...
  //Escribe tu código aquí
  return conversorEuroADolar(euro);
}

function verificalatra(letra)
{
