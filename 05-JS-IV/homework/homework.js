...
function agregarPropiedad (objeto, property) {
  ...
  // Tu código:
   ...
   objeto[property] = null;// dinamico, no se que estoy recibiendo por parametro en property utilizo los corchetes,
   return objeto;
}
...
function tienePropiedad (objeto, propiedad) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código:
  return objeto.hasOwnProperty(propiedad);//verifica si tiene tal propiedad
}
